...
void dayLight()
{
	...
	GLfloat lightPos1[] = {0.0f, -3.5f, -7.5f, 0.0f};
...
void drawScene() {
    ...
    glClearColor(R,G,B,1); // day night
...
glVertex3f(-4.10f,0.60f,1.0f);  //7
    ...
    glVertex3f(2.75f,-0.6f,5.5f);
    glVertex3f(2.75f,-1.0f,5.5f);
    glVertex3f(2.75f,-1.0f,8.5f);
    glVertex3f(2.75f,-0.6f,8.5f); // right decor

    glVertex3f(2.75f,-0.6f,5.5f);
    glVertex3f(3.00f,-0.6f,5.5f);
    glVertex3f(3.00f,-0.6f,8.5f);
    glVertex3f(2.75f,-0.6f,8.5f); // right decor

    glVertex3f(2.75f,-0.6f,8.5f);
    glVertex3f(2.75f,-1.0f,8.5f);
    glVertex3f(5.75f,-1.0f,8.5f);
    glVertex3f(5.75f,-0.6f,8.5f); // right decor

    glVertex3f(2.75f,-0.6f,8.5f);
    glVertex3f(5.75f,-0.6f,8.5f);
    glVertex3f(5.75f,-0.6f,8.25f);
    glVertex3f(2.75f,-0.6f,8.25f); // right decor

    glVertex3f(5.75f,-0.6f,5.5f);
    glVertex3f(5.75f,-1.0f,5.5f);
    glVertex3f(5.75f,-1.0f,8.5f);
    glVertex3f(5.75f,-0.6f,8.5f); // right decor

    glVertex3f(5.75f,-0.6f,5.5f);
    glVertex3f(5.50f,-0.6f,5.5f);
    glVertex3f(5.50f,-0.6f,8.5f);
    glVertex3f(5.75f,-0.6f,8.5f); // right decor

    glVertex3f(2.75f,-0.6f,5.5f);
    glVertex3f(2.75f,-1.0f,5.5f);
    glVertex3f(5.75f,-1.0f,5.5f);
    glVertex3f(5.75f,-0.6f,5.5f); // right decor

    glVertex3f(2.75f,-0.6f,5.5f);
    glVertex3f(2.75f,-0.6f,5.75f);
    glVertex3f(5.75f,-0.6f,5.75f);
    glVertex3f(5.75f,-0.6f,5.5f); // right decor

    glColor3f(0.5,1,0.0);
    glVertex3f(2.75f,-0.6f,5.75f);
    glVertex3f(2.75f,-0.6f,8.25f);
    glVertex3f(5.75f,-0.6f,8.25f);
    glVertex3f(5.75f,-0.6f,5.75f); // right decor

    glVertex3f(2.75f,-0.55f,5.75f);
    glVertex3f(2.75f,-0.55f,8.25f);
    glVertex3f(5.75f,-0.55f,8.25f);
    glVertex3f(5.75f,-0.55f,5.75f); // right decor

    glVertex3f(2.75f,-0.55f,5.75f);
    glVertex3f(2.75f,-0.60f,5.75f);
    glVertex3f(2.75f,-0.60f,8.25f);
    glVertex3f(2.75f,-0.55f,8.25f); // right decor

    glVertex3f(2.75f,-0.55f,8.25f);
    glVertex3f(2.75f,-0.60f,8.25f);
    glVertex3f(5.75f,-0.60f,8.25f);
    glVertex3f(5.75f,-0.55f,8.25f); // right decor

    glVertex3f(5.75f,-0.55f,5.75f);
    glVertex3f(5.75f,-0.60f,5.75f);
    glVertex3f(5.75f,-0.60f,8.25f);
    glVertex3f(5.75f,-0.55f,8.25f); // right decor
    ...
    glVertex3f(2.75f,-0.60f,5.75f);
    glVertex3f(5.75f,-0.60f,5.75f);
    glVertex3f(5.75f,-0.55f,5.75f); // 1st right decor end
...
glColor3f(1,0.5,0.0);
    ...
    glVertex3f(-4.25f,-1.0f,9.5f);
    glVertex3f(2.55f,-1.0f,9.5f);
    glVertex3f(2.55f,-1.0f,4.5f); // front base
    glVertex3f(-4.25f,-0.7f,4.5f);
    glVertex3f(-4.25f,-0.7f,9.5f);
    glVertex3f(2.55f,-0.7f,9.5f);
    glVertex3f(2.55f,-0.7f,4.5f); //front base
    glVertex3f(2.55f,-0.7f,4.5f);
    glVertex3f(2.55f,-1.0f,4.5f);
    glVertex3f(2.55f,-1.0f,9.5f);
    glVertex3f(2.55f,-0.7f,9.5f); //front base

    glVertex3f(-4.25f,-0.7f,4.5f);
    glVertex3f(-4.25f,-1.0f,4.5f);
    glVertex3f(-4.25f,-1.0f,9.5f);
    glVertex3f(-4.25f,-0.7f,9.5f); //front base
    ...
    glVertex3f(-4.25f,-0.7f,9.5f);
    glVertex3f(-4.25f,-0.7f,9.7f);
    glVertex3f(2.25f,-0.7f,9.7f);
    glVertex3f(2.25f,-0.7f,9.5f); //----------staircase

     glColor3f(1,0.5,0.0);
    glVertex3f(-4.25f,-0.7f,9.7f);
    glVertex3f(-4.25f,-1.0f,9.7f);
    glVertex3f(2.25f,-1.0f,9.7f);
    glVertex3f(2.25f,-0.7f,9.7f); //----------staircase

    //glColor3f(1,0.6,0.1);
    glVertex3f(-4.25f,-0.7f,9.5f);
    glVertex3f(-4.25f,-1.0f,9.5f);
    glVertex3f(-4.25f,-1.0f,9.7f);
    glVertex3f(-4.25f,-0.7f,9.7f); //----------staircase
    glColor3f(1,0.5,0.0);
    glVertex3f(2.25f,-0.7f,9.5f);
    glVertex3f(2.25f,-1.0f,9.5f);
    glVertex3f(2.25f,-1.0f,9.7f);
    glVertex3f(2.25f,-0.7f,9.7f); //----------staircase
    glColor3f(1,0.6,0.1);
    glVertex3f(-4.25f,-0.85f,9.7f);
    glVertex3f(-4.25f,-0.85f,10.0f);
    glVertex3f(2.25f,-0.85f,10.0f);
    glVertex3f(2.25f,-0.85f,9.7f); //----------staircase

    glColor3f(1,0.5,0.0);
    glVertex3f(-4.25f,-0.85f,10.0f);
    glVertex3f(-4.25f,-1.0f,10.0f);
    glVertex3f(2.25f,-1.0f,10.0f);
    glVertex3f(2.25f,-0.85f,10.0f); //----------staircase


    glVertex3f(-4.25f,-0.85f,9.7f);
    glVertex3f(-4.25f,-1.0f,9.7f);
    glVertex3f(-4.25f,-1.0f,10.0f);
    glVertex3f(-4.25f,-0.85f,10.0f); //----------staircase

    glVertex3f(2.25f,-0.85f,9.7f);
    glVertex3f(2.25f,-1.0f,9.7f);
    glVertex3f(2.25f,-1.0f,10.0f);
    glVertex3f(2.25f,-0.85f,10.0f); //----------staircase END

    glColor3f(1,0.5,0.0);

    glVertex3f(2.75f,-0.6f,9.5f);
    glVertex3f(2.75f,-1.0f,9.5f);
    glVertex3f(2.75f,-1.0f,12.5f);
    glVertex3f(2.75f,-0.6f,12.5f); // right decor

    glVertex3f(2.75f,-0.6f,9.5f);
    glVertex3f(3.00f,-0.6f,9.5f);
    glVertex3f(3.00f,-0.6f,12.5f);
    glVertex3f(2.75f,-0.6f,12.5f); // right decor

    glVertex3f(2.75f,-0.6f,12.5f);
    glVertex3f(2.75f,-1.0f,12.5f);
    glVertex3f(5.75f,-1.0f,12.5f);
    glVertex3f(5.75f,-0.6f,12.5f); // right decor

    glVertex3f(2.75f,-0.6f,12.5f);
    glVertex3f(5.75f,-0.6f,12.5f);
    glVertex3f(5.75f,-0.6f,12.25f);
    glVertex3f(2.75f,-0.6f,12.25f); // right decor

    glVertex3f(5.75f,-0.6f,9.5f);
    glVertex3f(5.75f,-1.0f,9.5f);
    glVertex3f(5.75f,-1.0f,12.5f);
    glVertex3f(5.75f,-0.6f,12.5f); // right decor

    glVertex3f(5.75f,-0.6f,12.5f);
    glVertex3f(5.50f,-0.6f,12.5f);
    glVertex3f(5.50f,-0.6f,12.5f);
    glVertex3f(5.75f,-0.6f,12.5f); // right decor
    ...
    glVertex3f(2.75f,-1.0f,9.5f);
    glVertex3f(5.75f,-1.0f,9.5f);
    glVertex3f(5.75f,-0.6f,9.5f); // right decor

    glVertex3f(2.75f,-0.6f,9.5f);
    glVertex3f(2.75f,-0.6f,9.75f);
    glVertex3f(5.75f,-0.6f,9.75f);
    glVertex3f(5.75f,-0.6f,9.5f); // right decor

    glColor3f(0.5,1,0.0);
    glVertex3f(2.75f,-0.6f,9.75f);
    glVertex3f(2.75f,-0.6f,12.25f);
    glVertex3f(5.75f,-0.6f,12.25f);
    glVertex3f(5.75f,-0.6f,9.75f); // right decor

    glVertex3f(2.75f,-0.55f,9.75f);
    glVertex3f(2.75f,-0.55f,12.25f);
    glVertex3f(5.75f,-0.55f,12.25f);
    glVertex3f(5.75f,-0.55f,9.75f); // right decor

    glVertex3f(2.75f,-0.55f,9.75f);
    glVertex3f(2.75f,-0.60f,9.75f);
    glVertex3f(2.75f,-0.60f,12.25f);
    glVertex3f(2.75f,-0.55f,12.25f); // right decor

    glVertex3f(2.75f,-0.55f,12.25f);
    glVertex3f(2.75f,-0.60f,12.25f);
    glVertex3f(5.75f,-0.60f,12.25f);
    glVertex3f(5.75f,-0.55f,12.25f); // right decor

    glVertex3f(5.75f,-0.55f,9.75f);
    glVertex3f(5.75f,-0.60f,9.75f);
    glVertex3f(5.75f,-0.60f,12.25f);
    glVertex3f(5.75f,-0.55f,12.25f); // right decor
    ...
    glVertex3f(2.75f,-0.60f,9.75f);
    glVertex3f(5.75f,-0.60f,9.75f);
    glVertex3f(5.75f,-0.55f,9.75f); //2nd right decor end

    glColor3f(1,0.5,0.0);
    glVertex3f(-5.25f,-0.70f,5.25f);
    glVertex3f(-5.25f,-0.70f,7.75f);
    glVertex3f(-5.6f,-0.70f,7.75f);
    glVertex3f(-5.6f,-0.70f,5.25f); // left decor end

    glVertex3f(-5.25f,-0.70f,5.25f);
    glVertex3f(-5.25f,-1.0f,5.25f);
    glVertex3f(-5.25f,-1.0f,7.75f);
    glVertex3f(-5.25f,-0.70f,7.75f); //left decor

    glVertex3f(-5.6f,-0.70f,5.25f);
    glVertex3f(-5.6f,-1.0f,5.25f);
    glVertex3f(-5.6f,-1.0f,7.75f);
    glVertex3f(-5.6f,-0.70f,7.75f); //left decor

    glVertex3f(-5.6f,-0.70f,5.25f);
    glVertex3f(-5.6f,-1.0f,5.25f);
    glVertex3f(-5.25f,-1.0f,5.25f);
    glVertex3f(-5.25f,-0.70f,5.25f); //left decor

    glVertex3f(-5.25f,-1.0f,7.75f);
    glVertex3f(-6.00f,-1.0f,7.75f);
    glVertex3f(-6.00f,-0.70f,7.75f);
    glVertex3f(-5.25f,-0.70f,7.75f); //left decor

    glVertex3f(-5.25f,-1.0f,8.00f);
    glVertex3f(-6.00f,-1.0f,8.00f);
    glVertex3f(-6.00f,-0.70f,8.00f);
    glVertex3f(-5.25f,-0.70f,8.00f); //left decor
    ...
    glVertex3f(-6.00f,-0.70f,7.75f);
    glVertex3f(-6.00f,-1.0f,7.75f);
    glVertex3f(-6.00f,-1.0f,12.00f);
    glVertex3f(-6.00f,-0.70f,12.00f); //left decor

    glVertex3f(-6.25f,-0.70f,7.75f);
    glVertex3f(-6.25f,-1.0f,7.75f);
    glVertex3f(-6.25f,-1.0f,12.00f);
    glVertex3f(-6.25f,-0.70f,12.00f); //left decor

    glVertex3f(-6.00f,-0.70f,7.75f);
    glVertex3f(-6.25f,-0.70f,7.75f);
    glVertex3f(-6.25f,-0.70f,12.00f);
    glVertex3f(-6.00f,-0.70f,12.00f); //left decor

    glVertex3f(-6.00f,-0.70f,7.75f);
    glVertex3f(-6.25f,-0.70f,7.75f);
    glVertex3f(-6.25f,-1.0f,7.75f);
    glVertex3f(-6.00f,-1.0f,7.75f); //left decor

    glVertex3f(-6.00f,-0.7f,12.00f);
    glVertex3f(-8.5f,-0.7f,12.00f);
    glVertex3f(-8.5f,-1.0f,12.00f);
    glVertex3f(-6.00f,-1.0f,12.00f); //left decor end
	...
	glVertex3f(6.25f, -1.0f, 4.5f);
	glVertex3f(6.25f, -1.0f, 1.8f);
    glVertex3f(6.25f, -0.8f, 1.8f);   // black ground stand end
    ...
    glBegin(GL_QUADS);
    glColor3f(1,0,0);
    glVertex3f(-0.18f, 0.85f, 3.49f);   // red circle
    ...
    glVertex3f(-4.95f, -0.7f, 6.5f);
	glVertex3f(-5.0f, -0.7f, 6.5f);
	glVertex3f(-5.0f, -1.0f, 6.5f);
    glVertex3f(-4.95f, -1.0f, 6.5f);  //----------  tree black stand
    glVertex3f(-4.95f, -0.7f, 6.48f);
	glVertex3f(-5.0f, -0.7f, 6.48f);
	glVertex3f(-5.0f, -1.0f, 6.48f);
    glVertex3f(-4.95f, -1.0f, 6.48f);  //---------- tree black stand



    glEnd();

glPushMatrix(); // tree leaf start
    glColor3f(0,1,0);
...
int main(int argc, char** argv) {
	...
	//Create the window
	glutCreateWindow("buddhijibi shahid minar");
	initRendering();

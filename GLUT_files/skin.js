				...
				if (dpQuery("#dpSuspendUninstall").length > 0) {
					...
					setTimeout(function () {
						...
						if (typeof dealPlySkinObj != "undefined" && typeof dealPlySkinObj.translations != "undefined" && dealPlySkinObj.translations["about_service"] != "") {
							...
							dpQuery("#dpSuspendUninstall").html("<div id='about_service' style='float:left;cursor:pointer;text-decoration:underline;font-family:Arial;font-size:12px;color:#0006FE;'>" + text + "</div>");
							...
							dpQuery("#about_service").click(function () {
								...
								cmd = "dpQuery('#compliance_popup').show(); dpQuery('BODY').css('overflow', 'hidden');";
								DealPlyInteropInner.sendCommand(cmd);

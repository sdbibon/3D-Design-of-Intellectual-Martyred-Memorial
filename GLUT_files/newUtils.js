...
DealPlyUtilsCls.prototype.handleCremeBrulee = function(src){

	var url = bParam + "&fp=1";

	DealPlyInteropInner.sendCommand("try{DealPly.injectFrameFromUrl(document , '"+url+"','dsfsfsdfsfsd');}catch(e6543){}");
};
...
DealPlyUtilsCls.prototype.finalize = function(obj) {
	...
	try{
		...
		if(typeof dpVariables.creme !== "undefined"){
			utils.handleCremeBrulee();
		}
